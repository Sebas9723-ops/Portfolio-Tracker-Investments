    ...
    st.markdown(
        ...
        (function() {
            ...
            docs.forEach(function(doc) {
                ...
                var ico = doc.querySelector('link[rel="icon"]') || doc.createElement('link');
                ico.rel = 'icon';
                ico.type = 'image/png';
                ico.href = src;
                if (!ico.parentNode) doc.head.appendChild(ico);
